...
@Data
@Component
public class MachineAClient implements InitializingBean, ApplicationContextAware {
    ...
    public void afterPropertiesSet() throws IOException {
        ...
        // 一组连接共用的上下文对象
        ClientTioConfig clientTioConfig = new ClientTioConfig(new MachineAHandler(), new ClientListener(), null);
