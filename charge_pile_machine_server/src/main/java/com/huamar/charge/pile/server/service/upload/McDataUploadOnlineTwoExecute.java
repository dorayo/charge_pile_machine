...
import com.huamar.charge.pile.dto.McChargerOnlineInfoDTO;
 ...
 */
@Service
public class McDataUploadOnlineTwoExecute implements McDataUploadExecute {
    ...
    public McDataUploadEnum getCode() {
        return McDataUploadEnum.COMMON_0X28;
    }
