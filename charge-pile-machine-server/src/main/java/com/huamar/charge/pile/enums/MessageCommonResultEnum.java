 ...
 */
@Getter
public enum MessageCommonResultEnum {
    ...
    MessageCommonResultEnum(String code, String desc) {
        this.code = code;
        this.desc = desc;
    }

    public static MessageCommonResultEnum getByCode(String code) {
        for (MessageCommonResultEnum e : values()) {
