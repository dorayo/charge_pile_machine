...
public class PileChargeArgConfig extends PileEventBaseDTO {
	...
	public short carTotalVoltage;

	// 充电机同步时间 BCD[6] 见表 14，年月日时分秒
	public BCD synTime;

	// 充电机最高输出电压 WORD 单位：0.1V/bit，偏移 0V
	public short chargerMaxOutVoltage;

	// 充电机最低输出电压 WORD 单位：0.1V/bit，偏移 0V
	public short chargerMinOutVoltage;

	// 充电机最大输出电流 WORD 单位 0.1A/bit，偏移-1600A
	public short chargerMaxOutElectricity;
