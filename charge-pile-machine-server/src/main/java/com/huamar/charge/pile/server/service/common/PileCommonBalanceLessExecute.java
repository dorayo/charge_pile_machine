...
@Slf4j
@Component
public class PileCommonBalanceLessExecute implements McCommonResultExecute<McCommonReq> {
    ...
    public PileCommonResultEnum getCode() {
        return PileCommonResultEnum.BALANCE_LESS_THAN;
    }
