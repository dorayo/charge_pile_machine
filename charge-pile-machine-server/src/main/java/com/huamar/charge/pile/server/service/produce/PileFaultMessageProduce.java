...
public class PileFaultMessageProduce implements InitializingBean, RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnsCallback {
    ...
    public void send(Object object) {
        ...
        messageProperties.setMessageId(snowflake.nextIdStr());
        Message message = new Message(JSONParser.jsonString(object).getBytes(), messageProperties);
        rabbitTemplate.send(DEFAULT_EXCHANGE, pileMachineProperties.getPileFaultQueue(), message);
    }
