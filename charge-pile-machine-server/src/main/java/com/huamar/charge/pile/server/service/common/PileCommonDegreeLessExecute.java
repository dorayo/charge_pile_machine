...
@Slf4j
@Component
public class PileCommonDegreeLessExecute implements McCommonResultExecute<McCommonReq> {
    ...
    public PileCommonResultEnum getCode() {
        return PileCommonResultEnum.DEGREE_LESS_THAN;
    }
