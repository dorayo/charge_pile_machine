...
public class McDataUploadStageExecute implements McDataUploadExecute {
    ...
    private ChargeStageDataDTO parse(MachineDataUpItem data) {
        ...
        chargeStageDataDTO.setBatteryChargeVoltage(reader.readUnsignedShort());
        chargeStageDataDTO.setBatteryChargeElectricity(reader.readUnsignedShort());
        chargeStageDataDTO.setElectricityState(reader.readByte());
        chargeStageDataDTO.setMaxVoltage(reader.readUnsignedShort());
        chargeStageDataDTO.setMaxVoltageNumber(reader.readUnsignedShort());
        chargeStageDataDTO.setMaxTemperature(reader.readUnsignedByte());
        chargeStageDataDTO.setMaxTemperatureNumber(reader.readUnsignedByte());
        chargeStageDataDTO.setMinTemperature(reader.readUnsignedByte());
        chargeStageDataDTO.setMinTemperatureNumber(reader.readUnsignedByte());
        chargeStageDataDTO.setRemainChargeTime(reader.readUnsignedShort());
        chargeStageDataDTO.setPileVoltageOutValue(reader.readUnsignedShort());
        chargeStageDataDTO.setPileElectricityOutValue(reader.readUnsignedShort());
