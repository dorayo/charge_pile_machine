...
public class HMacMD5Util {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        System.out.println(HexExtUtil.encodeHexStr(digest, false));

        System.out.println(HMacMD5Util.bytesToHexString(macmd5).equals(HexExtUtil.encodeHexStr(digest, false)));
    }
